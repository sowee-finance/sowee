...
| `apps/landing` (#144) | yes | the marketing site: the two-screen motion ported from the reference the team picked, the bond card, and the market read behind it | the team chose the reference and ruled that none of its photography or footage would be used; the listings, the empty state and the click targets were verified against the live market |
