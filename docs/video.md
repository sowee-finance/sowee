...
| 1:05 | phone: Selfie Check in the Sandbox World App | "First, a World Selfie Check — a few seconds of liveness that shows a real person is there. It's an anti-sybil signal, not identity — medium assurance, not a guarantee of one account per person. The nullifier is anchored on the same topic, so one World ID can't verify a second wallet." |
