...
const PROFILES: readonly SeedProfile[] = [
  ...
  {
    key: "freight-25d",
    issuerName: "PT Logistik Cepat Nusantara",
    payorName: "Mega Manufaktur Indonesia",
  ...
  {
    key: "pharma-30d",
    issuerName: "PT Medika Distribusi Utama",
    payorName: "Rumah Sehat Hospital Group",
  ...
  {
    key: "agri-60d",
    issuerName: "CV Sumber Agri Ekspor",
    payorName: "Java Trade Commodities Pte",
  ...
  },
  {
    ...
    issuerName: "PT Bangun Karya Subkontraktor",
    payorName: "Garuda Infrastruktur Prima",
  ...
  {
    key: "garment-90d",
    issuerName: "PT Cahaya Garmen Ekspor",
    payorName: "Pacific Apparel Buyers Ltd",
